...
return function(Commandments,Client)
	...
	Commandments:addCmd('ban','Ban a user',function(msgObj,Parameter)
		if msgObj.guild == nil then
				msgObj:reply('This command must be used inside a guild you have ban permissions on');
				return nil;
			end;
	...
	Commandments:addCmd('unban','Unban a user',function(msgObj,Parameter)
		if msgObj.guild == nil then
				msgObj:reply(Commandments.Prefix..'unban must be used inside a guild you have ban permissions on');
				return nil;
			end;		
			local snowflake = '';
			if Parameter == '' then
	...
	Commandments:addCmd('kick','Kick a user',function(msgObj,Parameter)
		if msgObj.guild == nil then
				msgObj:reply(Commandments.Prefix..'kick must be used inside a guild you have kick permissions on');
				return nil;
			end;
			local snowflake = '';
			if Parameter == '' then
